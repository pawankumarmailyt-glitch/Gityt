                ...
                if text.startswith("/start"):
                    ...
                    if "verify_" in text:
                        try:
                            ...
                            if uid == user_id:
                                verify_user(user_id)
                                send_message(chat_id, "✅ Verification Successful! अब आप bot use कर सकते हैं 🎉")
                            else:
...
🔐 Use karne ke liye pehle verify kare
📱 Phir apna mobile number bheje

⚡ Fast • Secure • Premium Data

👉 Start by sending your number after verification
""")
                    continue
                ...
                if not is_verified(user_id):
                    ...
                    send_message(chat_id, f"🔒 Please verify to continue:\n{link}")
                    continue
